...
//when the rotation speed slider is changed //SNL:I commented this out
// function rot_speed_change (evnt) {
//     var value = evnt.target.value;
//     rot_speed = value / 10000;
// }
// when the set lat button is pressed //SNL:I commented this out
...
function indexjs_setup() {
    ...
    //add the ground
    // load_ground(); SNL:I commented this
